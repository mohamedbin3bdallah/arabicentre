<?php
$data = getAllDataFromTable($select,'users',$where,$limit);
if(!empty($data))
{
?>
		...
		<div class="col-sm-12 table-responsive">
			<table class="table table-bordered table-striped" style="text-align: center;">
				<tr class="info">
					...
					<th><?php language('paycourses'); ?></th>
					<th><?php language('freecourses'); ?></th>
				</tr>
				<?php	for($i=0;$i<sizeof($data);$i++)	{	?>
					<tr id="tr-<?php echo $data[$i]['id'];?>">
						...
						<!--<td><input type="number" name="paycourses" min="0" step="1" value="<?php echo $data[$i]['paycourses']; ?>" onchange="update('users','paycourses',this.value,'where id = <?php echo $data[$i]['id']; ?>');"></td>-->
						<td>
						...
						<td><input type="number" name="freecourses" min="0" step="1" value="<?php echo $data[$i]['freecourses']; ?>" onchange="update('users','freecourses',this.value,'where id = <?php echo $data[$i]['id']; ?>');"></td>
					</tr>
