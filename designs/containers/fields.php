			...
			<form class="form-horizontal" action="admin.php?c=<?php echo $_GET['c']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-3 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<?php if(isset($row['picture']) && $row['picture'] != '') { ?><img src="uploads/fields/<?php echo $row['picture']; ?>" width="70%"><?php } ?>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10">
...
<?php
$data = getAllDataFromTable($select,'fields',$where,$limit);
if(!empty($data))
{
?>
			...
			<table class="table table-bordered table-striped" style="text-align: center;">
				...
				<?php	for($i=0;$i<sizeof($data);$i++)	{	?>
					<tr id="tr-<?php echo $data[$i]['id'];?>">
						...
						<td><img src="uploads/fields/<?php echo $data[$i]['picture']; ?>" width="30%"></td>
							...
							<div id="del-<?php echo $data[$i]['id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-sm">
									<div class="modal-content">
										...
										<center>
											<button class="btn btn-danger" onclick="mydelete('<?php echo $data[$i]['id'];?>','fieldid','fields','courses')" data-dismiss="modal"><?php language('agree'); ?></button>
...
<div id="cantdelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content"  style="background-color: red;">
			<div class="modal-body">
				<center style="color: #fff;">
					<?php language('cantdelete'); language('courses'); ?>
				</center>
			</div>
		</div>
	</div>
