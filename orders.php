		...
		<div class="container">
			...
			<div class="row" style="margin-bottom:25px; text-align:center;">
				...
				<div class="col-sm-2 col-md-2 col-sm-offset-1 col-md-offset-1">
						...
						<label for="npayed" class="">Not Payed</label>
						...
						<table class="table table-bordered">
							...
							<?php for($od=0;$od<count($orders);$od++) { ?>
								<tr class="<?php if($orders[$od]['dtime'] != '' && time() >  strtotime( '+1 month', $orders[$od]['dtime'])) echo 'danger'; elseif($orders[$od]['delivered'] == 0) echo 'warning'; elseif($orders[$od]['delivered'] == 1) echo 'success'; ?>">
									...
									<td width="20%" style="color:#666666;"><?php echo '$'.$orders[$od]['total'].' / Month'; ?></td>
									...
									<td width="10%">
										...
										<div class="dropdown">
											<a href="#" class="btn btn-danger" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Renow
												<span class="caret"></span>
											</a>			
											<ul class="dropdown-menu">
												<li><a href="orders.php?paymethod=bank&id=<?php echo $orders[$od]['id']; ?>">Bank account</a></li>
												<li><a href="orders.php?paymethod=paypal&id=<?php echo $orders[$od]['id']; ?>">Paypal</a></li>
											</ul>
										</div>
										<?php } ?>
									</td>
			...
			<div class="row" style="text-align:center;">
				<div class="col-sm-12 col-md-12">
					<nav>
						<ul class="pagination">
							<?php if($totalPages > 1) { ?><li><a href="?page=1">First</a></li><?php } ?>
							<?php if($page > 3) { ?><li>
							...
							<?php if($totalPages > 1) { ?><li><a href="?page=<?php echo $totalPages; ?>">Last</a></li><?php } ?>
						</ul>
					</nav>
				</div>
			</div>
