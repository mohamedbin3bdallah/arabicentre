		...
		<div class="container">
			...
			<div class="row" style="margin-bottom:25px; text-align:center; color:red;">
				<div class="col-sm-8 col-md-8 col-sm-offset-3 col-md-offset-3">
					<?php
						if(isset($_GET['message']) && $_GET['message'] == 'm1') echo 'All Inputs are Required';
						elseif(isset($_GET['message']) && $_GET['message'] == 'm2') echo 'Something Wrong';
						elseif(isset($_GET['message']) && $_GET['message'] == 'm3') echo 'Valid Username';
						elseif(isset($_GET['message']) && $_GET['message'] == 'm4') echo 'Valid Email';
						elseif(isset($_GET['message']) && $_GET['message'] == 'm5') echo 'Valid Referral Email';
						elseif(isset($_GET['message']) && $_GET['message'] == 'm6') echo 'Success, Please Check Your Email To Activate Your Account';
					?>
				</div>
			</div>
			...
			<div class="row">
			<div class="col-sm-8 col-md-8 col-sm-offset-3 col-md-offset-3">
				<form class="form-horizontal" action="register.php" method="POST" enctype="multipart/form-data" autocomplete="off">
				<div class="form-group">
					...
					<div class="col-sm-10 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<input type="text" class="form-control" name="username" id="username" pattern="[A-Za-z]{5,}" title="More than or equal 5 charachers" maxlength="100" placeholder="Username" autocomplete="off" required/>
					</div>
				</div>
				<div class="form-group">
					<label for="email" class="col-sm-2 <?php if($lang == 'ar') echo 'col-sm-push-10'; ?> control-label">Email</label>
					<div class="col-sm-10 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<input type="email" class="form-control" name="email" id="email" maxlength="200" placeholder="Email" autocomplete="off" required/>
					</div>
				</div>
				<div class="form-group">
					<label for="password" class="col-sm-2 <?php if($lang == 'ar') echo 'col-sm-push-10'; ?> control-label">Password</label>
					<div class="col-sm-10 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<input type="password" class="form-control" name="password" id="password" pattern="{8,}" title="More than or equal 8" placeholder="Password" autocomplete="off" required/>
					</div>
				</div>
				<div class="form-group">
					<label for="referral" class="col-sm-2 <?php if($lang == 'ar') echo 'col-sm-push-10'; ?> control-label">Referral Email</label>
					<div class="col-sm-10 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<input type="email" class="form-control" name="referral" id="referral" maxlength="200" placeholder="Referral Email" autocomplete="off"/>
					</div>
				</div>
				<div class="form-group">
