<?php
	...
	include('develops/blogfront.php');
?>
<!doctype html>
				...
				<div class="col-sm-12 col-md-12 table-responsive">
					<?php if(!empty($blog)) { ?>
						<table class="table table-bordered">
							...
							<?php for($bg=0;$bg<count($blog);$bg++) { ?>
								<tr>
									<td width="50%"><a style="color:#666666;" href="single.php?id=<?php echo $blog[$bg]['id']; ?>"><?php echo $blog[$bg]['title']; ?></a></td>
									<td width="50%" style="color:#666666;"><?php echo date('Y-m-d , h:i:sa', $blog[$bg]['time']); ?></td>
								</tr>
							<?php } ?>
						</table>
