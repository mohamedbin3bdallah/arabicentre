...
<meta name="keywords" content="<?php if(!empty($fields)) { $keywords = ''; for($fl=0;$fl<count($fields);$fl++) { $keywords .= $fields[$fl]['title'].' '; } echo $keywords; } ?>" />
...
<section id="" class="contact-parlex">
	<div class="parlex-back">
		<div class="container">
			...
			<div class="row">
			<?php if(!empty($fields)) { ?>
				<?php for($fl=0;$fl<count($fields);$fl++) { ?>
					<div class="col-sm-3 col-md-3" style="text-align: center;">
						<div class="thumbnail">
							<img src="<?php echo 'uploads/fields/'.$fields[$fl]['picture']; ?>" alt="<?php echo $fields[$fl]['title']; ?>">
							<div class="caption">
								<h3><a style="color:#666666;" href="courses.php?id=<?php echo $fields[$fl]['id']; ?>"><?php echo $fields[$fl]['title']; ?></a></h3>
							</div>
						</div>
					</div>
				<?php } ?>
