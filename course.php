...
<!--[if lt IE 9]> 
    ...
    <![endif]-->
<title><?php if(isset($course['title'])) echo $course['title']; ?></title>
<meta name="description" content="<?php if(isset($course['title'])) echo $course['title']; ?>">
<meta name="keywords" content="<?php if(isset($course['title'])) echo $course['title']; ?>" />
			...
			<?php if(!empty($course)) { ?>
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<center><img class="img-responsive" src="<?php echo 'uploads/courses/'.$course['picture']; ?>" alt="<?php echo $course['title']; ?>" style="border-radius:55px;"></center>
					</div>
				</div>
