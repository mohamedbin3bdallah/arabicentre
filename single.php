				...
				<div class="row">
					...
					<?php if(!empty($blogimgs)) { ?>
						<?php for($bim=2;$bim<count($blogimgs)+2;$bim++) { ?>
							<div style="margin-top:15px;" class="<?php if(count($blogimgs) == 1) echo 'col-lg-12 col-md-12'; elseif(count($blogimgs) == 2) echo 'col-lg-6 col-md-6'; elseif(count($blogimgs) == 3) echo 'col-lg-4 col-md-4'; else echo 'col-lg-3 col-md-3'; ?> col-sm-6 col-xs-12">
								<center><img class="img-responsive" src="<?php echo 'uploads/blog/'.$_GET['id'].'/'.$blogimgs[$bim]; ?>" alt="<?php echo $single['title']; ?>" style="border-radius:55px;"></center>
							</div>
						<?php } ?>
					<?php } ?>
				</div>
